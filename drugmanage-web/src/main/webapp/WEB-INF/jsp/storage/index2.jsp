...
<body>
	...
	<script type="text/javascript">
										...
										.each(
												...
												function(i, storage) {
													...
													tableData += '      <td>'
																		...
																		+ '</td>';
													tableData += '      <td>';
											 		tableData += '	      <button type="button"  onclick="deatil('+storage.supplierid+')" class="btn btn btn-success btn-xs"><i class=" glyphicon glyphicon-pencil">查看明细</i></button>';
											 		if(storage.status == 0){
		...
		//明细 
		function deatil(id){
			window.location.href ="${APP_PATH}/storage/detail";
		}
