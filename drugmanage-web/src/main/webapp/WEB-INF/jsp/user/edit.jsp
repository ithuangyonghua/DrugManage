    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">药品管理 - 用户修改</a></div>
        </div>
			  ...
			  <div class="panel-body">
				<form role="form" id="editForm">
				  <div class="form-group">
					...
					<input type="text"  class="form-control" id="loginacct" value="${userInfo.loginacct}" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="username"  value="${userInfo.username}" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
			    ...
			    $("#updateBtn").click(function(){
			    	 ...
			    	 $.ajax({
			    		 ...
			    		 success:function(result){
			    			 ...
			    			 if(result.success){
			    				 layer.msg("用户信息修改成功", {time:1000, icon:6, shift:6}, function(){
			    					 window.location.href="${APP_PATH}/user/index"
					    		 });
			    			 }else{
			    				 layer.msg("用户信息修改失败,请重新输入", {time:1000, icon:5, shift:6}, function(){
					    			 //alert("回调方法");
					    		 });
			    			 }
			    		 }
