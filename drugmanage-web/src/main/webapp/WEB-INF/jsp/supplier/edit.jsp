    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">药品管理 - 供应商修改</a></div>
        </div>
			  ...
			  <div class="panel-body">
				<form role="form"  id="editForm">
				  ...
				  <input type="hidden" id="id" value="${supplierInfo.supplierid}"/>
					...
					<input type="text"  class="form-control" id="suppliername" value="${supplierInfo.suppliername}" placeholder="请输入供应商名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">供应商电话</label>
					<input type="text" class="form-control" id="phone"  value="${supplierInfo.phone}" placeholder="请输入供应商电话">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">供应商地址</label>
					<input type="text" class="form-control" id="address"  value="${supplierInfo.address}"  placeholder="请输入供应商地址">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">供应商负责人</label>
					<input type="text" class="form-control" id="fzr"  value="${supplierInfo.fzr}" placeholder="请输入供应商负责人">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">供应商明细</label>
					<input type="text" class="form-control" id="detailid"  value="${supplierInfo.detailid}" placeholder="请输入供应商明细">
				  </div>
			    ...
			    $("#updateBtn").click(function(){
			    	 ...
			    	 $.ajax({
			    		 ...
			    		 success:function(result){
			    			 ...
			    			 if(result.success){
			    				 layer.msg("供应商信息修改成功", {time:1000, icon:6, shift:6}, function(){
			    					 window.location.href="${APP_PATH}/supplier/index"
					    		 });
			    			 }else{
			    				 layer.msg("供应商信息修改失败,请重新输入", {time:1000, icon:5, shift:6}, function(){
					    			 //alert("回调方法");
					    		 });
			    			 }
			    		 }
