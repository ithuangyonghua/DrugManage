    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">药品管理 - 药品分类修改</a></div>
        </div>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form">
				  ...
				  <input type="hidden"  id= "dcategoryid" name="dcategoryid" value="${drugCategoryInfo.dcategoryid}"/>
					<label for="exampleInputPassword1">名称</label>
					<input type="text"  class="form-control" id="name" value="${drugCategoryInfo.name}" placeholder="请输入分类名称">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	 ...
			    	 $.ajax({
			    		 type:"POST",
			    		 url:"${APP_PATH}/drugcategory/update",
			    		 data:{
			    			 "dcategoryid":$("#dcategoryid").val(),
			    			 "name":name
			    		 },
			    		 ...
			    		 success:function(result){
			    			 ...
			    			 if(result.success==true){
			    				 layer.msg("药品分类信息修改成功", {time:1000, icon:6, shift:6}, function(){
			    					 window.location.href="${APP_PATH}/drugcategory/index"
					    		 });
			    			 }else{
			    				 layer.msg("药品分类信息修改失败,请重新输入", {time:1000, icon:5, shift:6}, function(){
					    			 //alert("回调方法");
					    		 });
			    			 }
			    		 }
